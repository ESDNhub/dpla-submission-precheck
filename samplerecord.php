    ...
    <body>                  
        ...
        <div class="container-fluid">
						...
						if(empty($set)){
								...
								$type = isset($samplearray->type->data) ? $samplearray->type->data : array();
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <?php if(!empty($date)) { ?>
                                                ...
                                                <?php if(!empty($format)) { ?>
                                                    <tr><th>Format</th><td><?php foreach( $format as $singlefmt) { echo $singlefmt."<br/>"; };?></td></tr>
                                                <?php } ?>
                                                
                                                <?php if(!empty($type)) { ?>
                                                    <tr><th>Type</th><td><?php foreach( $type as $singletype) { echo $singletype."<br/>"; };?></td></tr>
                                                <?php } ?>
